...
public class EmailVerificationService {
    ...
    public static String getDefaultVerifiedDate(String countryCode) {
        ...
        List<String> EMAIL_VERIFICATION_COUNTRIES = Arrays.asList("ca", "ar", "bo", "br", "cl", "co", "cr", "ec", "sv", "gt", "hn", "mx", "ni", "pa", "py", "pe", "do", "uy", "at", "be", "cz", "dk", "fi", "fr", "de", "hu", "it", "lu", "nl", "no", "pl", "sk", "es", "se", "ch", "gb", "ru");
